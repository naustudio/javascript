module.exports = {
  ...
  rules: {
    ...
    // Don't require stateless functions when not using lifecycle methods, setState or ref
    ...
    // OFF: First prop in a JSX element must be on a new line when the element is multiline
    ...
    // we don't restrict ext. that has JSX
